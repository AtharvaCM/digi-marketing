...
export default function Paginated({ posts, itemsPerPage = 6 }: Readonly<{ posts: Sanity.BlogPost[]; itemsPerPage?: number }>) {
  ...
  function scrollToList() {
    if (typeof window !== 'undefined') document.querySelector('#blog-list')?.scrollIntoView({ behavior: 'smooth' });
  }
